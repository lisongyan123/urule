...
public class ComplexScorecardEditorServletHandler extends RenderPageServletHandler {
    ...
    public void execute(HttpServletRequest var1, HttpServletResponse var2) throws ServletException, IOException {
        ...
        if (var3 != null) {
            ...
            Template var7 = this.ve.getTemplate("html/complexscorecard-editor.html", "utf-8");
    ...
    public void importExcel(HttpServletRequest var1, HttpServletResponse var2) throws Exception {
        ...
        try {
            ...
            ComplexScoreTableBuilder var24 = new ComplexScoreTableBuilder(var9, this.c, var22, this.d);
            ComplexScorecardDefinition var25 = var24.buildTable();
    ...
    private ScoreTableData a(InputStream var1) throws Exception {
        ...
        if (var2.getNumberOfSheets() == 0) {
            ...
            for(int var7 = 1; var7 <= var5; ++var7) {
                ...
                for(int var11 = 0; var11 < var6.size(); ++var11) {
                    ...
                    if (var12 != null) {
                        ...
                        if (var13 != 0) {
                            TableHeader var14 = (TableHeader)var6.get(var11);
                            ...
                            CellType var18 = var12.getCellTypeEnum();
                            switch(var18) {
                                case STRING:
            ...
            var2.close();
            return new ScoreTableData(var6, var3);
        }
    }
    ...
    private List<TableHeader> a(XSSFSheet var1) {
