...
public class ActionTemplateContentRefactor extends ContentRefactor {
    public ActionTemplateContentRefactor() {
    }

    public boolean support(String var1) {
        var1 = var1.toLowerCase();
        return var1.endsWith(FileType.ActionTemplate.toString()) || var1.indexOf("__rules_templates__") > 0;
    }
