...
public class ScorecardEditorServletHandler extends RenderPageServletHandler {
	...
	public ScorecardEditorServletHandler() {
	}
	...
	public void execute(HttpServletRequest var1, HttpServletResponse var2) throws ServletException, IOException {
		...
		if (var3 != null) {
			...
			Template var7 = this.ve.getTemplate("html/scorecard-editor.html", "utf-8");
	...
	public void importExcel(HttpServletRequest var1, HttpServletResponse var2) throws Exception {
		...
		try {
			...
			ScoreTableBuilder var24 = new ScoreTableBuilder(var9, this.c, var22, this.d);
			ScorecardDefinition var25 = var24.buildTable();
