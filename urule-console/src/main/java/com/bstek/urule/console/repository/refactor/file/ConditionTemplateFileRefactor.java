...
public class ConditionTemplateFileRefactor extends FileRefactor {
    public ConditionTemplateFileRefactor() {
    }
    ...
    public boolean support(String var1) {
        return var1.toLowerCase().endsWith(FileType.ConditionTemplate.toString());
    }
}